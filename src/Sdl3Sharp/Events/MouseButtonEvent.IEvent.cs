...
partial struct Event
{
	...
	partial interface IUnionMembers
	{
		...
		static abstract Event Create(in MouseButtonEvent value);
		...
		/// </para>
		/// </remarks>
		bool TryGetValue(out MouseButtonEvent value);
	}
#endif
	...
	static Event IUnionMembers.Create(in MouseButtonEvent value) => From(in value);

	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	readonly bool IUnionMembers.TryGetValue(out MouseButtonEvent value) => TryGet(out value);
#endif
}

partial struct MouseButtonEvent : IEvent<MouseButtonEvent>
{
	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	private static bool AcceptsEventType(EventType type) => type is EventType.MouseButtonDown or EventType.MouseButtonUp;

	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	static bool IEvent<MouseButtonEvent>.TryReadFromEvent(ref readonly Event @event, out MouseButtonEvent result)
	{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	readonly void IEvent<MouseButtonEvent>.WriteToEvent(ref Event @event) => @event.Button = this;
}
