...
partial struct Event
{
	...
	partial interface IUnionMembers
	{
		...
		static abstract Event Create(in MouseWheelEvent value);
		...
		/// </para>
		/// </remarks>
		bool TryGetValue(out MouseWheelEvent value);
	}
#endif
	...
	static Event IUnionMembers.Create(in MouseWheelEvent value) => From(in value);

	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	readonly bool IUnionMembers.TryGetValue(out MouseWheelEvent value) => TryGet(out value);
#endif
}

partial struct MouseWheelEvent : IEvent<MouseWheelEvent>
{
	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	private static bool AcceptsEventType(EventType type) => type is EventType.MouseWheel;

	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	static bool IEvent<MouseWheelEvent>.TryReadFromEvent(ref readonly Event @event, out MouseWheelEvent result)
	{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	readonly void IEvent<MouseWheelEvent>.WriteToEvent(ref Event @event) => @event.Wheel = this;
}
