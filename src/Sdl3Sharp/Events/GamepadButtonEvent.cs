...
/// <summary>
/// Represents an event that occurs when a gamepad button is pressed or released
/// </summary>
/// <remarks>
/// <para>
...
public partial struct GamepadButtonEvent : IFormattable, ISpanFormattable
{
	...
	/// When setting this property, the given <see cref="EventType"/> is not a valid type for a <see cref="GamepadButtonEvent"/>
	/// </exception>
	public required EventType Type
	{
		...
		set
		{
			...
			{
				[DoesNotReturn]
				static void failInvalidEventType(EventType type) => throw new ArgumentException($"Invalid event type for {nameof(GamepadButtonEvent)}: {type}.", nameof(value));
	...
	{
		[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)] readonly get => unchecked((GamepadButton)mButton);
		[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)] set => mButton = unchecked((byte)value);
	}
	...
	public readonly string ToString(string? format, IFormatProvider? formatProvider)
		=> $"{{ {mCommon.ToPartialString()}, {
			...
			nameof(Button)}: {unchecked((GamepadButton)mButton)}, {
	...
	public readonly bool TryFormat(Span<char> destination, out int charsWritten, ReadOnlySpan<char> format = default, IFormatProvider? provider = default)
	{
		...
		return SpanFormat.TryWrite("{ ", ref destination, ref charsWritten)
			...
			&& SpanFormat.TryWrite(unchecked((GamepadButton)mButton), ref destination, ref charsWritten)
