...
partial struct Event
{
	...
	partial interface IUnionMembers
	{
		...
		static abstract Event Create(in JoyBallEvent value);
		...
		/// </para>
		/// </remarks>
		bool TryGetValue(out JoyBallEvent value);
	}
#endif
	...
	static Event IUnionMembers.Create(in JoyBallEvent value) => From(in value);

	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	readonly bool IUnionMembers.TryGetValue(out JoyBallEvent value) => TryGet(out value);
#endif
}

partial struct JoyBallEvent : IEvent<JoyBallEvent>
{
	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	private static bool AcceptsEventType(EventType type) => type is EventType.JoystickBallMotion;

	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	static bool IEvent<JoyBallEvent>.TryReadFromEvent(ref readonly Event @event, out JoyBallEvent result)
	{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	readonly void IEvent<JoyBallEvent>.WriteToEvent(ref Event @event) => @event.JBall = this;
}
