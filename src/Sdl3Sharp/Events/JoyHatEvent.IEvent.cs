...
partial struct Event
{
	...
	partial interface IUnionMembers
	{
		...
		static abstract Event Create(in JoyHatEvent value);
		...
		/// </para>
		/// </remarks>
		bool TryGetValue(out JoyHatEvent value);
	}
#endif
	...
	static Event IUnionMembers.Create(in JoyHatEvent value) => From(in value);

	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	readonly bool IUnionMembers.TryGetValue(out JoyHatEvent value) => TryGet(out value);
#endif
}

partial struct JoyHatEvent : IEvent<JoyHatEvent>
{
	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	private static bool AcceptsEventType(EventType type) => type is EventType.JoystickHatMotion;

	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	static bool IEvent<JoyHatEvent>.TryReadFromEvent(ref readonly Event @event, out JoyHatEvent result)
	{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	readonly void IEvent<JoyHatEvent>.WriteToEvent(ref Event @event) => @event.JHat = this;
}
