...
partial struct Event
{
	...
	partial interface IUnionMembers
	{
		...
		static abstract Event Create(in QuitEvent value);
		...
		/// </para>
		/// </remarks>
		bool TryGetValue(out QuitEvent value);
	}
#endif
	...
	static Event IUnionMembers.Create(in QuitEvent value) => From(in value);

	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	readonly bool IUnionMembers.TryGetValue(out QuitEvent value) => TryGet(out value);
#endif
}

partial struct QuitEvent : IEvent<QuitEvent>
{
	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	private static bool AcceptsEventType(EventType type) => type is EventType.Quit;

	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	static bool IEvent<QuitEvent>.TryReadFromEvent(ref readonly Event @event, out QuitEvent result)
	{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	readonly void IEvent<QuitEvent>.WriteToEvent(ref Event @event) => @event.Quit = this;
}
