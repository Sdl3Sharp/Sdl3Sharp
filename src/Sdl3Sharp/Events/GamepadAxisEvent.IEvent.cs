...
partial struct Event
{
	...
	partial interface IUnionMembers
	{
		...
		static abstract Event Create(in GamepadAxisEvent value);
		...
		/// </para>
		/// </remarks>
		bool TryGetValue(out GamepadAxisEvent value);
	}
#endif
	...
	static Event IUnionMembers.Create(in GamepadAxisEvent value) => From(in value);

	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	readonly bool IUnionMembers.TryGetValue(out GamepadAxisEvent value) => TryGet(out value);
#endif
}

partial struct GamepadAxisEvent : IEvent<GamepadAxisEvent>
{
	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	private static bool AcceptsEventType(EventType type) => type is EventType.GamepadAxisMotion;

	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	static bool IEvent<GamepadAxisEvent>.TryReadFromEvent(ref readonly Event @event, out GamepadAxisEvent result)
	{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	readonly void IEvent<GamepadAxisEvent>.WriteToEvent(ref Event @event) => @event.GAxis = this;
}
