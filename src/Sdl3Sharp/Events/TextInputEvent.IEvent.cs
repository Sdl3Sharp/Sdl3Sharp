...
partial struct Event
{
	...
	partial interface IUnionMembers
	{
		...
		static abstract Event Create(in TextInputEvent value);
		...
		/// </para>
		/// </remarks>
		bool TryGetValue(out TextInputEvent value);
	}
#endif
	...
	static Event IUnionMembers.Create(in TextInputEvent value) => From(in value);

	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	readonly bool IUnionMembers.TryGetValue(out TextInputEvent value) => TryGet(out value);
#endif
}

partial struct TextInputEvent : IEvent<TextInputEvent>
{
	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	private static bool AcceptsEventType(EventType type) => type is EventType.TextInput;

	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	static bool IEvent<TextInputEvent>.TryReadFromEvent(ref readonly Event @event, out TextInputEvent result)
	{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	readonly void IEvent<TextInputEvent>.WriteToEvent(ref Event @event) => @event.Text = this;
}
