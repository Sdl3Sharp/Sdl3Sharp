...
/// <summary>
/// Represents an event that occurs when a <see cref="Input.Mouse"/> device is added or removed
/// </summary>
/// <remarks>
/// <para>
...
public partial struct MouseDeviceEvent : IFormattable, ISpanFormattable
{
	...
	/// When setting this property, the given <see cref="EventType"/> is not a valid type for a <see cref="MouseDeviceEvent"/>
	/// </exception>
	public required EventType Type
	{
		...
		set
		{
			...
			{
				[DoesNotReturn]
				static void failInvalidEventType(EventType type) => throw new ArgumentException($"Invalid event type for {nameof(MouseDeviceEvent)}: {type}.", nameof(value));
	...
	/// <summary>
	/// Gets or sets the <see cref="Mouse.Id">ID</see> of the <see cref="Input.Mouse"/> associated with this event
	/// </summary>
	/// <value>
	/// The <see cref="Mouse.Id">ID</see> of the <see cref="Input.Mouse"/> associated with this event
	/// </value>
	public uint MouseId
	{
	...
	/// <summary>
	/// Gets or sets the <see cref="Input.Mouse"/> associated with this event
	/// </summary>
	/// <value>
	/// The <see cref="Input.Mouse"/> associated with this event
	/// </value>
	public Mouse Mouse
	{
