...
public readonly partial struct Mouse :
	IEquatable<Mouse>, IFormattable, ISpanFormattable, IEqualityOperators<Mouse, Mouse, bool>
{
	...
	public readonly string? Name
	{
		get
		{
			unsafe
			{
				...
				using var nameUtf16 = NativeStrings.FromUtf8ToUtf16(SDL_GetMouseNameForID(mId));
	...
	/// <inheritdoc/>
	public readonly override bool Equals([NotNullWhen(true)] object? obj) => obj is Mouse other && Equals(other);
	...
	public readonly bool TryFormat(Span<char> destination, out int charsWritten, ReadOnlySpan<char> format = default, IFormatProvider? provider = default)
	{
		unsafe
		{
			...
			var name = SDL_GetMouseNameForID(mId);
	...
	/// <inheritdoc/>
	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	public static bool operator ==(Mouse left, Mouse right) => left.Equals(right);

	/// <inheritdoc/>
	[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
	public static bool operator !=(Mouse left, Mouse right) => !(left == right);
}
